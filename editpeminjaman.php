<?php
include "config.php";
                    $query = "SELECT * FROM peminjaman INNER JOIN siswa ON peminjaman.RFID = siswa.RFID INNER JOIN barang ON peminjaman.ID_BARANG = barang.ID_BARANG
...
<div class="wrapper">
  ...
  <div class="form-group">
    ...
    <select id="kelas" name="RFID" class="form-control" >
        <option selected><?php echo $pinjam['RFID'] ?></option>
  ...
  <div class="form-group>
      ...
      <select id="kelas" name="idbarang" class="form-control" >
        <option selected><?php echo $pinjam['ID_BARANG']?></option>
 ...
 <a type="button" class="btn btn-secondary" data-dismiss="modal" href="barang.php">Batal</a>
</form> -->
</div>
<!-- disable enter -->
