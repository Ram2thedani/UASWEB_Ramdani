...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
    <form method="post" action="updatebrg.php">   
      <input type="hidden" id="idbarang" name="idbarang" value="<?php echo $barang['ID_BARANG'] ?>">   
  <div class="form-group">
    <label for="namabarang">Nama Barang</label>
    <input type="text" class="form-control" id="namabarang" name="namabarang" placeholder="Nama" value="<?php echo $barang['NAMA_BARANG']?>">
  </div>
  <div class="form-group">
    <label for="stok">Jumlah Stok</label>
    <input type="number" class="form-control" id="stok" name="stok" placeholder="Nama" value="<?php echo $barang['STOK']?>">
  </div>
