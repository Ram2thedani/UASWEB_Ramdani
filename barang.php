...
if (isset($_POST["tambah"])) {
    $query = "INSERT INTO barang VALUES('?', '$_POST[namabarang]', '$_POST[stok]')";
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td><a name="" id="" class="btn btn-warning" href="editbarang.php?id=<?php echo $barang['ID_BARANG'] ?>" role="button">Edit</a> 
                    <a href="hapusbrg.php?id=<?php echo $barang['ID_BARANG'] ?>" name="bthapus" id="" class="btn btn-danger" role="button">Hapus</a></td>
                  </tr>
                  <?php } ?>
                  </tfoot>
                </table>
