<?php
include "config.php";
$query = "SELECT * FROM siswa WHERE RFID='$_GET[id]'";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <input type="hidden" class="form-control has-validation" id="RFID" name="RFID" placeholder="No. RFID" onKeyPress="return keyPressed(event)" value="<?php echo $siswa['RFID'] ?>">
  </div>
 <div class="form-group">
    <label for="nama">Nama</label>
    <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama" value="<?php echo $siswa['NAMA'] ?>">
  </div>
  <div class="form-group>
      <label for="kelas">Kelas</label>
      <select id="kelas" name="kelas" class="form-control">
        <option selected><?php echo $siswa['KELAS'] ?></option>
 ...
 <a type="button" class="btn btn-secondary" data-dismiss="modal" href="siswa.php">Batal</a>
</div>
</form>
</div>
</div>
...
<div class="modal" tabindex="-1" role="dialog" id="modaltambah">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="namabarang" name="namabarang" placeholder="Nama">
  </div>
  <div class="form-group">
    <label for="stok">Jumlah Stok</label>
    <input type="number" class="form-control" id="stok" name="stok" placeholder="Nama">
  </div>
